...
def save_to_camera():
    ...
    if save_to_camera_callback is not None and callable(save_to_camera_callback):
        save_to_camera_callback(thresholds_to_save)   # можно передать сохранённое значение порога
